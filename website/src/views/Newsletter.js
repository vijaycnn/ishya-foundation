...
const JanPDF = "/Newsletters/Ishya's January Newsletter.pdf";
const FebPDF = "/Newsletters/Ishya Feb Newsletter.pdf";
const MarPDF = "/Newsletters/Ishya March Newsletter.pdf";
const AprPDF = "/Newsletters/Ishya April Newsletter.pdf";
const MayPDF = "/Newsletters/Ishya May Newsletter.pdf";
const JunePDF = "/Newsletters/Ishya June Newsletter.pdf";
const JulyPDF = "/Newsletters/Ishya July Newsletter.pdf";
const AugPDF = "/Newsletters/Ishya August Newsletter.pdf";
const SeptPDF = "/Newsletters/Ishya Sept Newsletter.pdf";
const OctPDF = "/Newsletters/Ishya Oct Newsletter.pdf";
const NovPDF = "/Newsletters/Ishya Nov Newsletter.pdf";
const DecPDF = "/Newsletters/Ishya December Newsletter.pdf";
const Jan25PDF = "/Newsletters/Ishya Jan Newsletter.pdf";
