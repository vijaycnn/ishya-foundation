...
function EditBanner() {
    ...
    const getBanner = async () => {
        ...
        await axiosInstance.get(`/banner/getById/${id}`)
          .then((response) => {
    ...
    const validation = (values) => {
        setError('');        
        let hasError = false;
        if ((uploadMediaFile == null && previousData.fileUrl.trim() == '')) {
  ...
  const getUploadUrl = async (file) => {
    ...
    const formProcess = async (fileUrl) => {        
        let body = {
            ...
            type        : previousData.type.trim(),
            title       : data.title.trim(),
            description : data.description.trim(),
            fileUrl     : fileUrl.trim()
        };
        // console.log("data >>", data);
        await axiosInstance.post(`/banner/update`, body)
            .then((response) => {
  ...
  return (
    <>
      ...
      <div className="mb-3 d-flex justify-content-between align-items-center">
        <h1 className="h4 mb-0 font-secondary fw-medium">Edit Banner</h1>
        <div>
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Row>                
                ...
                <Form.Group className="mb-4">
                    ...
                    <Form.Control type="text" name="description" value={data.description} placeholder="Enter Location"
                        onChange={handleChange}  />  
                </Form.Group>
            </Col>
